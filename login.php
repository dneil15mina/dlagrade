...
<html lang="en">
  ...
  <head>
    <title>DLA Grade Viewing Portal</title>
    <meta charset="utf-8">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
                <a href="<?php echo WEB_ROOT; ?>">Grade View Portal</a>
              </div>
            </div>
      ...
      <div class="ftco-cover-1 overlay" style="background-image: url('images/school.jpg')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5">
              <h1 class="line-bottom">Online Grade Viewing</h1>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 pr-md-5 mr-auto">
            ...
            <p>Kindly check you ID number and Password issued by your Adviser. Thank you</p>
          </div>
          <div class="col-md-6">
