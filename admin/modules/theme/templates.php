      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">DLA Grade Viewing Portal</a>
          </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          <nav>
            <ul>
              <li>
                <a href="https://dlaportal.net">
                  DLA PORTAL
                </a>
              </li>
              <li>
                <a href="http://dla.edu.ph">
                  About Us
                </a>
              </li>
              <li>
          ...
          <div class="copyright" id="copyright">
            ...
            <a href="https://dlaportal.net" target="_blank">DLA</a>. 2020
            <a href="dlaportal.net" target="_blank">COMP DEPT</a>.
          </div>
        </div>
      </footer>
    </div>
